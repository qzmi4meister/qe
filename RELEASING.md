...
Build on Apple Silicon with macOS 26 and Command Line Tools containing the macOS 26 SDK (Swift 6.2+). `VERSION` contains a version such as `0.3.1`; its tag is `v0.3.1`.
